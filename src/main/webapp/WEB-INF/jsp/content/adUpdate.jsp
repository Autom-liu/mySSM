...
<html>
	...
	<body>
		<div class="right">
				<form action="${basePath }/ad/edit" role="form" class="form-horizontal" id="form-data">
					<div class="row">
						<div class="form-group col-sm-5">
							...
							<div class="col-sm-8">
								...
								<input type="text" class="form-control" placeholder="" name="title" value="${ad.title }" />
							</div>
						</div>
					...
					<div class="row">
						<div class="form-group col-sm-5">
							...
							<div class="col-sm-8">
								<input type="text" class="form-control" placeholder="" name="link" value="${ad.link }"/>
							</div>
						</div>
						<div class="form-group col-sm-7">
							...
							<div class="col-sm-6">
								<input type="text" class="form-control" placeholder="值越大排名越靠前" name="weight" value="${ad.weight }"/>
							</div>
						</div>
					</div>
